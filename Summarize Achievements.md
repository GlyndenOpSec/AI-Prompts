Copilot Prompt: Extract Completed Items from Progress List
...
Prompt:
From the following disorganized list of progress items, extract a short, unformatted list (10–15 items) that clearly reflects tasks which are fully completed.
Focus only on items that are:

Marked as 100% complete
Explicitly stated as “completed,” “deployed,” “installed,” “activated,” “created,” “fixed,” or “closed”

Ignore items that are:

In progress (e.g., 85% complete, 90% complete, etc.)
Failed, pending, or require further action
Risk notes, discussions, or tickets still open

Return the results as a simple bullet list with no extra formatting or explanation.
Input List:
[Ask User for Input list]


4. Present the Answer
This prompt is designed to be copy-pasted directly into Copilot or any AI assistant that supports natural language processing. It uses clear filtering criteria and a concise output format.
